                ...
                <form>
                    <fieldset>
                        ...
                        <table class="formtable">
                           <tr>
                                <td>会议名称：</td>
                                <td>${requestScope.mname}</td>
                            </tr>
                            <tr>
                                <td>预计参加人数：</td>
                                <td>${requestScope.mnum}</td>
                            </tr>
                            <tr>
                                <td>预计开始时间：</td>
                            ...
                            <tr>
                                <td>预计结束时间：</td>
                                <td>${requestScope.mend}</td>
                            </tr>
                            <tr>
                                <td>会议说明：</td>
                                <td>
                                    <textarea id="description" rows="5" readonly>${requestScope.mnote}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>参会人员：</td>
                                <td>
                                    <table class="listtable">
                                        ...
                                        <c:forEach items="${requestScope.joinList}" var="user">
	                                        <tr>
	                                            <td>${user.uname}</td>
	                                            <td>${user.uphone}</td>
	                                            <td>${user.umail}</td>
                            ...
                            <tr>
                                <td class="command" colspan="2">
                                    ...
                                    onclick="window.location='CancelMeetingAction?mno=${requestScope.mno}'"/>
