                    ...
                    <fieldset>
                        ...
                        <table class="formtable">
                            <tr>
                                <td>门牌号:</td>
                                <td>
                                    <input id="roomnumber" name="rroom" type="text" value="${requestScope.rroom}" maxlength="10"/>
                                    <input name="rno" value="${requestScope.rno}" style="visibility:hidden"/>
                                </td>
                            </tr>
                            <tr>
                                <td>会议室名称:</td>
                                <td>
                                    <input id="capacity" name="rname" type="text" value="${requestScope.rname}" maxlength="20"/>
                                </td>
                            </tr>
                            <tr>
                                <td>最多容纳人数：</td>
                                <td>
                                    <input id="roomcapacity" name="rvol" type="text" value="${requestScope.rvol}"/>
                                </td>
                            </tr>
                            <tr>
                                <td>当前状态：</td>
                                <td>
                                	<c:if test="${requestScope.rstate==1}">
	                                ...
	                                <c:if test="${requestScope.rstate==0}">
	                                    <label><input type="radio" id="status" name="rstate" value="1" />启用</label>
	                                    <label><input type="radio" id="status" name="rstate" value="0" checked="checked" />停用</label>
	                                    <label><input type="radio" id="status" name="rstate" value="-1" />删除</label>
	                                </c:if>
	                                <c:if test="${requestScope.rstate==-1}">
	                                    <label><input type="radio" id="status" name="rstate" value="1" />启用</label>
	                                    <label><input type="radio" id="status" name="rstate" value="0" />停用</label>
	                                    <label><input type="radio" id="status" name="rstate" value="-1" checked="checked" />删除</label>
	                                </c:if>
                                </td>
                            </tr>
                            <tr>
                                <td>备注：</td>
                                <td>
                                    <textarea id="description" name="rnote" maxlength="200" rows="5" cols="60" >${requestScope.rnote}</textarea>
                                </td>
                            </tr>
                            <tr>
